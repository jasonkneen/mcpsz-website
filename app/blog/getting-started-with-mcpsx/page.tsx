          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-3xl mx-auto">
              <div className="mb-8">
                ...
                <h1 className="text-4xl md:text-5xl font-bold mb-6">Getting Started with mcpz: A Comprehensive Guide</h1>
              ...
              <div className="prose prose-invert prose-emerald max-w-none">
                <p className="lead text-xl text-gray-300 mb-8">
                  mcpz is a powerful CLI tool that streamlines how you work with Context Protocol (MCP) tools. In this comprehensive guide, we'll walk through installation, basic configuration, and creating your first tool groups to optimize your AI workflow.
                </p>

                <h2>What is mcpz?</h2>
                <p>
                  mcpz is a command-line interface designed to simplify the management of Context Protocol (MCP) tools. It allows you to organize your tools into logical groups, filter by use case, and significantly reduce token usage when interacting with AI models.
                </p>

                <h2>Installation</h2>
                <p>
                  Installing mcpz is straightforward. You can use npm to install it globally:
                </p>

                <pre className="bg-gray-950 p-4 rounded-md overflow-x-auto mb-6">
                  <code className="text-emerald-400">npm install -g @mcpz/cli</code>
                </pre>
                ...
                <pre className="bg-gray-950 p-4 rounded-md overflow-x-auto mb-6">
                  <code className="text-emerald-400">npx -y mcpz run</code>
                </pre>

                <h2>Basic Configuration</h2>
                <p>
                  After installation, the first step is to run mcpz to connect to your MCP servers:
                </p>

                <pre className="bg-gray-950 p-4 rounded-md overflow-x-auto mb-6">
                  <code className="text-emerald-400">mcpz run</code>
                </pre>
                ...
                <p>
                  One of the most powerful features of mcpz is the ability to create logical groups of tools for specific tasks or projects. Here's how to create your first group:
                </p>

                <pre className="bg-gray-950 p-4 rounded-md overflow-x-auto mb-6">
                  <code className="text-emerald-400">mcpz create-group web-dev --smart</code>
                </pre>

                <p>
                  The <code>--smart</code> flag tells mcpz to analyze your project and automatically suggest relevant tools based on your codebase.
                </p>
                ...
                <pre className="bg-gray-950 p-4 rounded-md overflow-x-auto mb-6">
                  <code className="text-emerald-400">mcpz list-groups</code>
                </pre>

                <h2>Using Tool Groups</h2>
                <p>
                  To start mcpz with a specific tool group:
                </p>

                <pre className="bg-gray-950 p-4 rounded-md overflow-x-auto mb-6">
                  <code className="text-emerald-400">mcpz run --group web-dev</code>
                </pre>

                <p>
                  This will start mcpz with only the tools in the "web-dev" group, significantly reducing token usage and improving response times when working with AI models.
                </p>

                <h2>Advanced Configuration</h2>
                <p>
                  mcpz offers several advanced configuration options:
                </p>

                <h3>Adding Tools to a Group</h3>
                <pre className="bg-gray-950 p-4 rounded-md overflow-x-auto mb-6">
                  <code className="text-emerald-400">mcpz add-tools --group web-dev --tools "code-indexer_search_code,file-operations_write_file"</code>
                </pre>

                <h3>Removing Tools from a Group</h3>
                <pre className="bg-gray-950 p-4 rounded-md overflow-x-auto mb-6">
                  <code className="text-emerald-400">mcpz remove-tools --group web-dev --tools "notification-server_broadcast_status"</code>
                </pre>

                <h3>Deleting a Group</h3>
                <pre className="bg-gray-950 p-4 rounded-md overflow-x-auto mb-6">
                  <code className="text-emerald-400">mcpz delete-group web-dev</code>
                </pre>

                <h2>Best Practices</h2>
                <p>
                  Here are some best practices for using mcpz effectively:
                </p>

                <ul>
                  <li>Create project-specific groups to optimize token usage</li>
                  <li>Use the <code>--smart</code> flag to leverage mcpz's AI-powered tool recommendations</li>
                ...
                <h2>Conclusion</h2>
                <p>
                  mcpz transforms how you work with Context Protocol tools, making your AI workflow more efficient and cost-effective. By organizing your tools into logical groups, you can significantly reduce token usage and improve response times.
                </p>

                <p>
                  In our next tutorial, we'll dive deeper into advanced features like cloud syncing, custom workflows, and integrating mcpz with popular AI models.
                </p>
              </div>
                ...
                <div className="grid gap-8 md:grid-cols-2">
                  <div className="bg-gray-900 p-6 rounded-lg border border-gray-800 hover:border-emerald-700 transition-colors">
                    <Link href="/blog/token-usage-reduction-case-study" className="flex items-center group">
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-400">A case study on implementing mcpz's grouping feature to reduce API costs.</p>
                      </div>
                  ...
                  <div className="bg-gray-900 p-6 rounded-lg border border-gray-800 hover:border-emerald-700 transition-colors">
                    <Link href="/blog/integrating-with-ai-models" className="flex items-center group">
                      <div className="flex-1">
                        <h4 className="font-bold mb-2 group-hover:text-emerald-400 transition-colors">Integrating mcpz with Claude and GPT Models</h4>
                        <p className="text-sm text-gray-400">A step-by-step guide to connecting mcpz with popular AI models.</p>
                      </div>
                      <ArrowRight className="h-5 w-5 text-emerald-400 group-hover:translate-x-1 transition-transform" />
                    </Link>
                  </div>
