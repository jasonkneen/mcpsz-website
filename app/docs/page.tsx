    ...
    <div className="flex min-h-screen flex-col bg-black text-white">
      ...
      <main className="flex-1 container mx-auto px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold mb-8">MCPSX CLI Documentation</h1>
          
          <div className="prose prose-invert max-w-none">
            <h2 className="text-2xl font-bold mt-8 mb-4 text-emerald-400">Overview</h2>
            <p className="mb-6">
              MCPSX CLI is a powerful command line interface for Model Context Protocol Server (MCPS), 
              designed to revolutionize how you manage, query, and interact with Model Context Protocol (MCP) 
              servers and tools. At its core, MCPSX enables intelligent organization of your MCP ecosystem, 
            ...
            <ul className="list-disc pl-6 mb-6 space-y-1">
              <li><code className="bg-gray-800 px-1 rounded">mcps</code> (primary command)</li>
...
mcpsx use "My Server"</pre>
            ...
            <ol className="list-decimal pl-6 mb-6 space-y-2">
              ...
              <li>
                <strong className="text-emerald-300">Run Servers & Tools</strong>: Start MCP servers and tools individually or in 
              ...
              <li>
                <strong className="text-emerald-300">Grouping</strong>: Create and manage groups of servers and tools for simplified workflows 
                and optimized model interactions.
              </li>
              <li>
                <strong className="text-emerald-300">Flexible Filtering</strong>: Run specific servers, tools, or combinations to 
            ...
            <ul className="list-disc pl-6 mb-4 space-y-1">
              <li><code className="bg-gray-800 px-1 rounded">-s, --server &lt;n&gt;</code> - Load only a specific server</li>
              <li><code className="bg-gray-800 px-1 rounded">-S, --servers &lt;names&gt;</code> - Load only specific servers (comma-separated)</li>
...
# Use a server group
mcpsx stdio --servers="python-stack"</pre>
              </div>
            </div>
            ...
            <div className="rounded-lg border border-gray-800 bg-gray-950 overflow-hidden mb-4">
              <div className="p-4 font-mono text-sm overflow-x-auto">
                <pre className="text-emerald-400">mcpsx groups add &lt;n&gt; --servers="server1,server2,..."</pre>
              </div>
            </div>
            <p className="mb-2">Example:</p>
            <div className="rounded-lg border border-gray-800 bg-gray-950 overflow-hidden mb-6">
              <div className="p-4 font-mono text-sm overflow-x-auto">
                <pre className="text-emerald-400"># Create a 'python-stack' group containing multiple servers
mcpsx groups add "python-stack" --servers="python,pytorch,huggingface"

# Create a 'favorites' group
mcpsx groups add "favorites" --servers="openai,anthropic"</pre>
              </div>
            </div>
            ...
            <h3 className="text-xl font-bold mt-6 mb-3 text-white">Server & Tool Groups</h3>
            <p className="mb-4">
              Groups are at the core of MCPSX's efficiency strategy. They allow you to create collections of MCP servers and tools 
              that can be used together. This is particularly valuable for organizing related components by project type, 
              technology stack, or specific workflows—while significantly reducing token usage when interacting with AI models.
            </p>
            <p className="mb-4">
              Groups act as "virtual MCPs" - when you reference a group name with <code className="bg-gray-800 px-1 rounded">--servers</code> or <code className="bg-gray-800 px-1 rounded">--tools</code>, 
              it expands to include all servers or tools in that group. This means you can send only the relevant tools to your AI models, 
...
mcpsx stdio --servers="ai-models,custom-server" --tools="predict"</pre>
              </div>
            </div>
            ...
            <p className="mb-6">
              ...
              This file is shared with the MCPS VSCode extension, ensuring consistent configuration across your entire development environment.
            </p>
            ...
            <p className="mb-6">
              ...
              By creating logical groups of tools and servers, you can:
            </p>
